...
<title>Tax Tips | Payroll Servicess</title>
<meta name="description" content="Tax tips covering quarterly filings, deductions, entity structuring, and sales tax for small businesses.">
<meta property="og:title" content="Tax Tips | Payroll Servicess">
<meta property="og:description" content="Tax tips covering quarterly filings, deductions, entity structuring, and sales tax for small businesses.">
...
<section class="hero hero-sm">
  <div class="container reveal in">
    <span class="eyebrow" style="background:rgba(255,255,255,0.15);color:#fff;"><i class="fa-solid fa-file-invoice-dollar"></i> Resources</span>
    <h1>Tax tips for business owners</h1>
    <p>Practical, actionable tax guidance to keep you compliant and reduce what you owe.</p>
  </div>
</section>
...
<section class="section">
  <div class="container">
    ...
    <div class="res-card reveal">
      <div class="res-thumb"><span class="res-tag">Tax Tips</span><i class="fa-solid fa-file-invoice-dollar"></i></div>
      <div class="res-body">
        <div class="meta">Tax Tips · 6 min read</div>
        <h3>Quarterly Estimated Taxes: A Simple Checklist</h3>
        <p>Avoid penalties with a clear, repeatable filing routine.</p>
        <a href="#" class="card-link">Read more <i class="fa-solid fa-arrow-right"></i></a>
      </div>
    </div>
    <div class="res-card reveal">
      <div class="res-thumb"><span class="res-tag">Tax Tips</span><i class="fa-solid fa-percent"></i></div>
      <div class="res-body">
        <div class="meta">Tax Tips · 5 min read</div>
        <h3>Deductions Small Businesses Commonly Miss</h3>
        <p>Legitimate write-offs owners often leave on the table.</p>
        <a href="#" class="card-link">Read more <i class="fa-solid fa-arrow-right"></i></a>
      </div>
    </div>
    <div class="res-card reveal">
      <div class="res-thumb"><span class="res-tag">Tax Tips</span><i class="fa-solid fa-building"></i></div>
      <div class="res-body">
        <div class="meta">Tax Tips · 7 min read</div>
        <h3>Choosing the Right Business Entity for Tax Purposes</h3>
        <p>How LLC, S-corp, and C-corp status change your tax bill.</p>
        <a href="#" class="card-link">Read more <i class="fa-solid fa-arrow-right"></i></a>
      </div>
    </div>
    <div class="res-card reveal">
      <div class="res-thumb"><span class="res-tag">Tax Tips</span><i class="fa-solid fa-store"></i></div>
      <div class="res-body">
        <div class="meta">Tax Tips · 6 min read</div>
        <h3>Sales Tax Nexus: What Growing Businesses Need to Know</h3>
        <p>When you owe sales tax in a new state, and how to stay ahead of it.</p>
        <a href="#" class="card-link">Read more <i class="fa-solid fa-arrow-right"></i></a>
      </div>
    </div>
    <div class="res-card reveal">
      <div class="res-thumb"><span class="res-tag">Tax Tips</span><i class="fa-solid fa-calendar"></i></div>
      <div class="res-body">
        <div class="meta">Tax Tips · 5 min read</div>
        <h3>Building a Tax Calendar You'll Actually Follow</h3>
        <p>A simple system for never missing a filing deadline again.</p>
        <a href="#" class="card-link">Read more <i class="fa-solid fa-arrow-right"></i></a>
      </div>
    </div>
    <div class="res-card reveal">
      <div class="res-thumb"><span class="res-tag">Tax Tips</span><i class="fa-solid fa-piggy-bank"></i></div>
      <div class="res-body">
        <div class="meta">Tax Tips · 6 min read</div>
        <h3>Year-End Tax Planning Moves to Make Now</h3>
        <p>Timing income and expenses before the year closes out.</p>
        <a href="#" class="card-link">Read more <i class="fa-solid fa-arrow-right"></i></a>
      </div>
    </div></div>
  </div>
