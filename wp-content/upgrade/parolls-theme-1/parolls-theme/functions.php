...
function parolls_theme_enqueue_assets() {
	...
	wp_enqueue_style( 'parolls-style', get_template_directory_uri() . '/assets/css/style.css', array(), '1.0.0' );
	wp_enqueue_script( 'parolls-main', get_template_directory_uri() . '/assets/js/main.js', array(), '1.0.0', true );
}
